        ...
        <div>
           <footer className="footer bg-base-200 text-base-content p-10">
                <nav>
                    ...
                    <a className="link link-hover">Network Management</a>
                    <a className="link link-hover">Cybersecurity</a>
                    <a className="link link-hover">IT Support Services</a>
                    <a className="link link-hover">AI and Machine Learning</a>
                    <a className="link link-hover">IT Consulting</a>
                    <a className="link link-hover">Blockchain Technology</a>
                    <a className="link link-hover">Data Analytics</a>
                    <a className="link link-hover">Cloud Computing</a>
                </nav>
                <nav>
                    <h6 className="footer-title">SERVICE REVIEW</h6>
                ...
                <aside className="grid-flow-col items-center">
                    ...
                    Service Review Ltd.
                    <br />
                    Copyright © GaLib - All right reserved
                    </p>
                </aside>
